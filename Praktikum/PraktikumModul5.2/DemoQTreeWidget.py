...
class MainForm(QWidget):
    ...
    def setupUi(self):
        ...
        self.addChild(parent1, 'Numerical Python',
        ...
        self.addChild(parent2, 'Beginning Ruby',
        'Peter Cooper', 'Apress')
        self.addChild(parent2, 'Ruby Under a Microscope',
        'Pat Shaughnessy', 'No Starch Press')
